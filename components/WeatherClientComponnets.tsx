...
export default  function WeatherClientComponnets({
    searchParams
}: {
    ...
    if (!weatherData) {
        return (
            <main className="min-h-screen bg-blue-400 p-4 flex items-center justify-center">
                <p className="text-white text-lg">Impossible de charger les données météo</p>
            </main>
        )
    }
    ...
    const weatherMain = weatherData.weather.weather[0]?.main?.toLowerCase() || ''
    const weatherTheme =
