...
export default function AirQuality({ aqi, components }: Props) {
  ...
  return (
    <div className=" md:mt-12 md:w-6/12 bg-gradient-to-b from-sky-500 to-indigo-500 shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-sky-500/25 backdrop-blur-lg rounded-2xl p-6 ">
